---
title: "II. DLM: CATCH-ONLY METHODS (COM)"
format: html
---
...
![](images/DLMII1.PNG){fig-align="center" width="80%"}
...
![](images/DLMII2.PNG){fig-align="center" width="80%"}
...
![](images/DLMII3.PNG){fig-align="center" width="80%"}
...
![](images/DLMII4.PNG){fig-align="center" width="80%"}
...
![](images/DLMII5.PNG){fig-align="center" width="80%"}
...
| Метод | MSY | B.Bmsy | TAC | Примечание |
|----------|------------|-------------|---------------|------------------------|
| DCAC | <NA> | <NA> | 6.0 |    Простая коррекция среднего улова |
