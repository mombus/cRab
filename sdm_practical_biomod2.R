...
# Скрипт: чистый R (без Quarto), с расширенной диагностикой и исправлениями ошибок
...
# Оценки и важности
print(get_evaluations(myBiomodModelOut))
print(get_variables_importance(myBiomodModelOut))
...
print(get_variables_importance(myBiomodEM))
