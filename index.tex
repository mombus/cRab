...
\NormalTok{  ) }\SpecialCharTok{+} 
  ...
  \FunctionTok{geom\_point}\NormalTok{(}
    \AttributeTok{data =}\NormalTok{ data, }
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ X, }\AttributeTok{y =}\NormalTok{ Y, }\AttributeTok{size =}\NormalTok{ Density), }\CommentTok{\# Размер по плотности}
...
\CommentTok{\# Сохранение графика (раскомментируйте)}
 \FunctionTok{ggsave}\NormalTok{(}\StringTok{"sdmTMBmap10.jpg"}\NormalTok{, }\AttributeTok{width =} \DecValTok{8}\NormalTok{, }\AttributeTok{height =} \DecValTok{8}\NormalTok{, }\AttributeTok{dpi =} \DecValTok{300}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{images/sdmTMBmap10.jpg}
...
\section{Присоединение факторов к данным
съемок}\label{ux43fux440ux438ux441ux43eux435ux434ux438ux43dux435ux43dux438ux435-ux444ux430ux43aux442ux43eux440ux43eux432-ux43a-ux434ux430ux43dux43dux44bux43c-ux441ux44aux435ux43cux43eux43a}
