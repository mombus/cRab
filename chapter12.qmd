...
Для минимальной работы 3-го скрипта необходимо подгрузить два csv-файла. Первый [файл](https://mombus.github.io/cRab/data/final_sdm_table_with_na.csv) для моделирования текущих данных и [файл](https://mombus.github.io/cRab/data/future_sdm_table_with_na.csv) - данные по будущему распределению предикторов, собранных с [Bio-ORACLE](https://www.bio-oracle.org/). Скрипты целиком: [первый](https://mombus.github.io/cRab/data/SDM_prepare_input_data.R), [второй](https://mombus.github.io/cRab/data/SDM_pred.R) и [третий](https://mombus.github.io/cRab/data/SDM_diag.R).
